...
export const GenerateRiskMatrixGeneralPDF = (data) => {
  ...
  img.onload = () => {
    ...
    doc.setFontSize(14);
    doc.text("Matriz de Riesgos General", titleX, headerTop + 14);
    doc.setFontSize(11);
    ...
    const fileName = `${safeTitle}_${dateString.replace(/\s/g, "_")}.pdf`;
    doc.save(fileName);
  };
};
