...
import { criticalityOptions } from "@/utils/HelpersLib";
...
const EventCreate = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const successMessage = await createEvent(formData);
  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center">
      <Paper elevation={10} sx={{ padding: 4, width: 500 }}>
        <Stack spacing={3} alignItems="center">
          ...
          <Typography variant="body2" color="text.secondary" textAlign="center">
            Llena los datos para registrar el evento.
          </Typography>
          ...
          >
            ...
            <ButtonDesign>Crear evento</ButtonDesign>
          </form>
      ...
      <ConfirmModalDesign
        ...
        title="Confirmación de crear el evento"
        message="¿Estás seguro de que deseas crear el evento con esos datos?"
