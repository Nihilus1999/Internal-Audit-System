...
import { steps } from "@/views/risk/riskCreate/RiskStepperConfig";
...
import { createRisk } from "@/services/Risk";
...
const ControlStepperCreate = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const success = await createRisk(formData);
      setSuccess(success);
      setSnackbarOpen(true);
      removeLocalStorageItems();
      setTimeout(() => navigate("/risks/manage-risks/crud"), 2000);
    } catch (error) {
      setSnackbarOpen(true);
    ...
    >
      ...
      >
        ...
        <ConfirmModalDesign
          ...
          title="Confirmación de creación del riesgo"
          message="¿Estás seguro de que deseas crear este riesgo con estos datos?"
